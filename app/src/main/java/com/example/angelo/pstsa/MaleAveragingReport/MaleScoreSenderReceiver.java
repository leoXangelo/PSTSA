package com.example.angelo.pstsa.MaleAveragingReport;
...
public class MaleScoreSenderReceiver extends AsyncTask<Void,Void,String> {
    ...
    int judgeCount;
    public MaleScoreSenderReceiver(Context c, String urlAddress, String query, HorizontalBarChart male, HorizontalBarChart female, int judgeCount) {
        this.c = c;
