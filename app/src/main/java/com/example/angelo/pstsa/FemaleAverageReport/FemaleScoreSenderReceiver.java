package com.example.angelo.pstsa.FemaleAverageReport;
...
public class FemaleScoreSenderReceiver extends AsyncTask<Void,Void,String> {
    ...
    int judgeCount;
    public FemaleScoreSenderReceiver(Context c, String urlAddress, String query, HorizontalBarChart male, HorizontalBarChart female, int judgeCount) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s != null)
        {
            if(!s.contains("null"))
            {
                ScoreParser p = new ScoreParser(c, s, male, female, judgeCount);
                p.execute();
