...
public class ParticipantSenderReceiver extends AsyncTask<Void,Void,String> {
    ...
    public ParticipantSenderReceiver(Context c, String urlAddress, String query, ListView lv, View bottomSheet) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s != null)
        {
            if(!s.contains("null"))
            {
                ParticipantParser p = new ParticipantParser(c, s, lv, bottomSheet);
                p.execute();
