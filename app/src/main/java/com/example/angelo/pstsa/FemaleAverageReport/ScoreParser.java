...
public class ScoreParser extends AsyncTask<Void,Void,Integer> {
    ...
    protected void onPostExecute(Integer integer) {
        ...
        if(integer==1)
        {
            ...
            //Set<String> hs1 = new LinkedHashSet<>(judge_names);
            //int judge_count = hs1.size();
            ...
            for (int x = 0; x < nameList.size(); x++){
                ...
                double final_score = total_score / judgeCount;
                scores.add(new BarEntry(x, (float) final_score));
                total_score = 0;
            }
            ...
            female.getAxisLeft().setAxisMaximum(100);
