...
public class CriteriaSenderReceiver extends AsyncTask<Void,Void,String> {
    ...
    ProgressDialog pd;
    Button btnActivate;
    public CriteriaSenderReceiver(Context c, String urlAddress, String query, ListView lv, View bottomSheet, Button btnActivate) {
        this.c = c;
    ...
    protected void onPostExecute(String s) {
        ...
        if(s != null)
        {
            if(!s.contains("null"))
            {
                CriteriaParser p = new CriteriaParser(c, s, lv, bottomSheet, btnActivate);
                p.execute();
